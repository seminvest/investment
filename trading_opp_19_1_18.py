...
if __name__ == "__main__":
    symbols = ['CRM','NOW','WDAY','AYX','HUBS','TWLO','DOCU','ADBE','OKTA','NEWR','INTU','PLAN','DBX','ZS','ZEN','AVGO','AMD','ANSS','SNPS','CDNS','MSFT','TWTR','ATVI','ADSK','WDC',
    'V','PYPL','AXP','DFS','SQ','CME','TRIP','NFLX','DIS','COST','MORN','NTES','ILMN','ISRG','HD','RDFN','NUAN','LRCX','AMAT','SPY','TSLA','BABA','XLNX','NVDA','XBI','QQQ','JD','MA','MTN','OLED',
    'PYPL','SFIX','EA','GOOGL','MU','FB','AAPL','AMZN']
