...
if __name__ == "__main__":
    print(sys.argv[1])
    symbols = ['TSLA','AAPL','AMZN','GOOGL','FB','BABA','TWTR','MSFT','CRM','NOW','WDAY','AYX','HUBS','TWLO','DOCU','ADBE','OKTA','NEWR','INTU','PLAN','DBX','ZS','ZEN','NTNX','ANSS','SNPS','CDNS',
    'ADSK','MA','V','PYPL','AXP','DFS','SQ','CME','COST','MORN','ILMN','ISRG','HD','RDFN','LRCX','AMAT','XLNX','NVDA',
    'AVGO','AMD','MU','OLED','XBI','QQQ','JD','MTN','SFIX','NTES','TRIP','NFLX','DIS','ATVI','EA']
