...
if __name__ == "__main__":
    print(sys.argv[1])
    symbols = ['CRM','NOW','WDAY','NEWR','HUBS','TWLO','ZEN','ADBE','OKTA','DATA','XLNX','NVDA','ANSS','SNPS','CDNS','MSFT','FB','AAPL', 'V','PYPL','AXP','MA','SQ','TSLA','HD','IRBT','DIS','COST','CME','OLED','BABA','NTES','ILMN','ISRG','UNH','AVGO','QCOM','WDC','MTN','WFC','QRVO','ANET','LOW','SWKS','ADI','TMUS','JPM','MET']
